        ...
        <div class="header">
			<div class="header-left">
				<a href="/home" class="logo">
					<img src="{{ asset('/assets/img/logo.png') }}" width="35" height="35" alt=""> <span>Meal Management</span>
				</a>
			</div>
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li class="submenu">
							<a href="#"><i class="fa fa-user"></i> <span> Meal Section </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
								<li><a href="{{ url('add.meal') }}">Add Meal</a></li>
                                <li><a href="{{ url('view.teacher.list') }}">Show Meal</a></li>
							</ul>
						</li>
                        ...
                        <li class="submenu">
							<a href="#"><i class="fa fa-user"></i> <span>Bazar Section </span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
                                <li><a href="{{ url('add.registration.fees') }}">Add Bazar</a></li>
								<li><a href="{{ url('add.monthly.fees') }}">Payment</a></li>
							</ul>
						</li>

                        <li class="submenu">
							<a href="#"><i class="fa fa-user"></i> <span>Report & Details</span> <span class="menu-arrow"></span></a>
							<ul style="display: none;">
                                <li><a href="{{ url('add.registration.fees') }}">Current Ovservation</a></li>
